...
Usage:
    python scripts/compile_exp1_alpha_sweep_v2.py
"""
...
# Paths
# ---------------------------------------------------------------------------
RESULTS_DIR = Path("experiment_results/exp1/model_alpha_sweep/top5impact_v2")
BENCHMARK_CSV = Path("experiment_results/model_benchmark/model_comparison.csv")
OUTPUT_DIR = Path("experiment_results/exp1/model_alpha_sweep/top5impact_v2/compiled")

# ---------------------------------------------------------------------------
# Gen2 filter
# ---------------------------------------------------------------------------
GEN2_FILTER = "top5impact_v2_n4"
...
def parse_gen2_dirname(dirname: str) -> tuple[str, str] | None:
    ...
    suffix = f"_top5impact_v2_n4_{model}_ZH"
