...
Example:
    python scripts/compare_party_impact.py \
        experiment_results/party_impact/high_impact/phase2/pipeline_e5_instruct_ZH_a03 \
        experiment_results/party_impact/high_impact/phase2/pipeline_e5_instruct_ZH_a04

    python scripts/compare_party_impact.py \
        experiment_results/party_impact/high_impact/phase2/pipeline_e5_instruct_ZH_a04 \
        experiment_results/party_impact/high_impact/phase2/pipeline_qwen3_ZH
"""
