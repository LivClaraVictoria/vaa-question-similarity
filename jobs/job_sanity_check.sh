...
# CRW pipeline sanity check. Expects PIPELINE_CONFIG env var.
# Usage: PIPELINE_CONFIG=configs/full_pipeline/base_data/pipeline_e5_ZH.py sbatch jobs/job_sanity_check.sh
...
python -u -m scripts.verify_crw_pipeline --config "${PIPELINE_CONFIG}"
