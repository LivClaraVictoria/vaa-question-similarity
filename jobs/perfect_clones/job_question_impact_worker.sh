#!/bin/bash
# Worker (SLURM array): clone one question 4× identical, compute baseline recs, measure distortion.
...
# Question impact worker — processes a single question.
# Launched as a SLURM job array by launch_question_impact.sh.
