...
# ── 2. Cloned pipelines ───────────────────────────────────────────────────────
echo ""
echo "=== Running cloned pipeline: identical_q32214_n10 ==="
python -u -m main --config configs/full_pipeline/cloned/identical_q32214_n10_e5_ZH.py

echo ""
echo "=== Running cloned pipeline: identical_highcandvar_n10 ==="
python -u -m main --config configs/full_pipeline/cloned/identical_highcandvar_n10_e5_ZH.py

echo ""
echo "=== Running cloned pipeline: identical_combinedvar_n10 ==="
python -u -m main --config configs/full_pipeline/cloned/identical_combinedvar_n10_e5_ZH.py
